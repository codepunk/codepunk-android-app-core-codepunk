 ...
 */
private const val DISABLE_DEV_OPTIONS_REQUEST_CODE = 2
...
class MainSettingsFragment :
    ...
    */
    ...
    private val developerOptionsPreference by lazy {
        findPreference(PREF_KEY_DEV_OPTIONS_ENABLED) as TwoTargetSwitchPreference
    }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putInt(KEY_DEV_OPTIONS_CLICKS_REMAINING, clicksToUnlockDeveloperOptions)
    }
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        clicksToUnlockDeveloperOptions = when {
            savedInstanceState != null ->
                savedInstanceState.getInt(
                    KEY_DEV_OPTIONS_CLICKS_REMAINING,
                    DEV_OPTS_CLICKS_TO_UNLOCK
                )
            sharedPreferences.getBoolean(PREF_KEY_DEV_OPTIONS_UNLOCKED, false) -> 0
        ...
        sessionManager.sessionLiveResource.observe(this, Observer { /* TODO onSession(it) */ })
        */
    }
                ...
                if (enabled) {
                    ...
                    requireFragmentManager().findFragmentByTag(CONFIRM_LOG_OUT_FRAGMENT_TAG)
                        ?: AlertDialogFragment.showDialogFragmentForResult(
                            this,
                            DISABLE_DEV_OPTIONS_REQUEST_CODE,
                            DISABLE_DEV_OPTIONS_DIALOG_FRAGMENT_TAG
                        )
                    false
                }
            }
    ...
    override fun onBuildAlertDialog(
        ...
        when (requestCode) {
            ...
            DISABLE_DEV_OPTIONS_REQUEST_CODE -> {
                builder
                    .setTitle(R.string.settings_dev_options_disable_dialog_title)
                    .setMessage(R.string.settings_dev_options_disable_dialog_message)
                    .setPositiveButton(android.R.string.ok, fragment)
                    .setNegativeButton(android.R.string.cancel, fragment)
            }
        }
    ...
    override fun onDialogResult(
        ...
        when (requestCode) {
            CONFIRM_LOG_OUT_REQUEST_CODE -> {
                when (resultCode) {
                    RESULT_POSITIVE -> { /* TODO sessionManager.closeSession(true) */
                    }
                }
            }
                    ...
                    Activity.RESULT_OK -> {
                        data?.also {
                            updateDeveloperOptions(
                                true,
                                it.getStringExtra(EXTRA_DEV_OPTIONS_PASSWORD_HASH)
                            )
                        }
                        Toast.makeText(
                            context,
                            R.string.settings_dev_options_now_a_developer,
                            Toast.LENGTH_SHORT
                        ).show()
                    }
                }
    ...
    private fun onRedundantUnlockRequest() {
        Toast.makeText(
            context,
            R.string.settings_dev_options_redundant_show_request,
            Toast.LENGTH_SHORT
        ).show()
    }
        ...
        if (steps in 1..DEV_OPTS_CLICKS_REMAINING_TOAST) {
            Toast.makeText(
                ...
                resources.getQuantityString(
                    R.plurals.settings_dev_options_steps_from_unlocking,
                    steps,
                    steps
                ),
                Toast.LENGTH_SHORT
    ...
    private fun updateDeveloperOptions(unlocked: Boolean, hash: String? = null) {
        ...
        sharedPreferences
            .edit()
            .putBoolean(PREF_KEY_DEV_OPTIONS_UNLOCKED, unlocked)
            .putBoolean(PREF_KEY_DEV_OPTIONS_ENABLED, enabled)
            .putString(
                PREF_KEY_DEV_OPTIONS_AUTHENTICATED_HASH,
    ...
    private fun updatePreferenceScreen() {
        isDeveloperOptionsUnlocked =
            sharedPreferences.getBoolean(PREF_KEY_DEV_OPTIONS_UNLOCKED, false)
    ...
    */
    ...
    companion object {
         ...
         */
        @JvmStatic
        private val DISABLE_DEV_OPTIONS_DIALOG_FRAGMENT_TAG =
            MainSettingsFragment::class.java.name + ".DISABLE_DEV_OPTIONS_DIALOG"
