...
class DeveloperOptionsPasswordDialogFragment :
    ...
    override fun newBuilder(savedInstanceState: Bundle?): AlertDialog.Builder {
        ...
        return AlertDialog.Builder(requireContext())
            ...
            .setMessage(R.string.settings_dev_options_password_dialog_message)
        ...
        when (view) {
            positiveBtn -> {
                ...
                if (BuildConfig.DEVELOPER_OPTIONS_PASSWORD_HASH.equals(hex, true)) {
                    ...
                    data = Intent().apply {
                        putExtra(
                            BuildConfig.EXTRA_DEV_OPTIONS_PASSWORD_HASH,
                    ...
                    binding.layout.error =
                        getString(R.string.settings_dev_options_incorrect_password)
                    shakeAnimator.start()
                }
            }
        }
